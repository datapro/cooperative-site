(function ($) {
  ...
  if (loanForm.length) {
    loanForm.each(function () {
      ...
      let minMonth = form.data("min-month");
      let maxMonth = form.data("max-month");
      let monthLabel = form.data("month-label");
      let minCount = form.data("min-count");
      let maxCount = form.data("max-count");
      let defaultCount = form.data("default-count");
      let stepsCount = form.data("count-steps");
      let defaultMonth = form.data("default-month");
      let currencySymbol = form.data("currency-symbol");
